...
import darren.udacity.project0.popularMovies.data.base.BaseContentProvider;
...
public class FavoritesProvider extends BaseContentProvider {
    ...
    public static final String AUTHORITY = "darren.udacity.project0.popularMovies.data";
    public static final String CONTENT_URI_BASE = "content://" + AUTHORITY;

    private static final int URI_TYPE_FAVORITE = 0;
    private static final int URI_TYPE_FAVORITE_ID = 1;

    private static final int URI_TYPE_TRAILER = 2;
    private static final int URI_TYPE_TRAILER_ID = 3;
    ...
    protected QueryParams getQueryParams(Uri uri, String selection, String[] projection) {
        ...
        if (id != null) {
            if (selection != null) {
                res.selection = res.idColumn + "=" + id + " and (" + selection + ")";
            } else {
                res.selection = res.idColumn + "=" + id;
            }
        } else {
